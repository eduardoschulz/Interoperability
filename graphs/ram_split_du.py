...
mpl.use('QtAgg') 
files = [
    "../logs/oai/oaicn/split/mem-du.csv",
    "../logs/oai/open5gs/split/mem-du.csv",
    "../logs/oai/free5gc/split/mem-du.csv",
    "../logs/srsran/oaicn/split/mem-du.csv",
    "../logs/srsran/open5gs/split/mem-du.csv",
    "../logs/srsran/free5gc/split/mem-du.csv",
]
...
# Add some text for labels, title and custom x-axis tick labels, etc.
    ax.set_ylabel('DU memory consumption (GB)', fontsize=14)
    ax.set_xticks(x + width/2, labels, fontsize=12)
    ax.set_ylim(0, 4)
    ax.legend(loc='upper right', ncols=2, fontsize=12)

    if save:
        fig.savefig("figs/ram-split-du.pdf", dpi=100)
