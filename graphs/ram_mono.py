...
mpl.use('QtAgg') 
files = [
    "../logs/oai/oaicn/mono/mem-gnb.csv",
    "../logs/oai/open5gs/mono/mem-gnb.csv",
    "../logs/oai/free5gc/mono/mem-gnb.csv",
    "../logs/srsran/oaicn/mono/mem-gnb.csv",
    "../logs/srsran/open5gs/mono/mem-gnb.csv",
    "../logs/srsran/free5gc/mono/mem-gnb.csv",
]
...
# Add some text for labels, title and custom x-axis tick labels, etc.
    ax.set_ylabel('gNB memory consumption (GB)', fontsize=14)
    ax.set_xticks(x + width/2, labels, fontsize=12)
    ax.set_ylim(0, 4)
    ax.legend(loc='upper right', ncols=2, fontsize=12)

    if save:
        fig.savefig("figs/ram-mono.pdf", dpi=100)
